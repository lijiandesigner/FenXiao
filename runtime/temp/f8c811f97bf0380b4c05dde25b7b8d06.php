<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"/Applications/MAMP/htdocs/FenXiao/public/../application/admin/view/Config/index.html";i:1510390286;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
<title>店铺信息</title>
  ...
  <table class="list-style Interlaced">
   <tr>
    ...
    <?php if(is_array($p->data) || $p->data instanceof \think\Collection || $p->data instanceof \think\Paginator): $i = 0; $__LIST__ = $p->data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$x): $mod = ($i % 2 );++$i;?>
      ...
      <td class="center">
       <a href="config/updata_show?id=<?php echo $x['id']; ?>" title="编辑"><img src="__STATIC__/admin/images/icon_edit.gif"/></a>
      </td>
      </tr>   
