<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/Applications/MAMP/htdocs/FenXiao/public/../application/admin/view/Tablezhuozi/index.html";i:1510390130;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>包房</title>
...
<script>
  function lay(id){
    layer.confirm(
      '确认删除？', 
      {btn: ['确定', '取消'],
      btn1:function(index, layero){window.location.href='tablezhuozi/del?id='+id}
...
<body>
 <div class="wrap">
  <div class="page-title">
    ...
    <span class="modular fr"><a href="tablezhuozi/add_show" class="pt-link-btn">+包房</a></span>
  </div>
  <table class="list-style Interlaced">
   ...
   <?php if(is_array($p->data) || $p->data instanceof \think\Collection || $p->data instanceof \think\Paginator): $i = 0; $__LIST__ = $p->data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$x): $mod = ($i % 2 );++$i;?>
      ...
      <td class="center">
        <a href="tablezhuozi/updata_show?id=<?php echo $x['id']; ?>" title="编辑"><img src="__STATIC__/admin/images/icon_edit.gif"/></a>
