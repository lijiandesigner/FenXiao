<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/Applications/MAMP/htdocs/FenXiao/public/../application/admin/view/Food/index.html";i:1510390024;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>商品</title>
 ...
 <div class="wrap">
  ...
  <table class="list-style Interlaced">
   ...
   <?php if(is_array($p->data) || $p->data instanceof \think\Collection || $p->data instanceof \think\Paginator): $i = 0; $__LIST__ = $p->data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$x): $mod = ($i % 2 );++$i;?>
      ...
      <td class="center">
      <a href="food/updata_show?id=<?php echo $x['id']; ?>" title="编辑"><img src="__STATIC__/admin/images/icon_edit.gif"/></a>
