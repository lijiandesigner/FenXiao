...
{   
    ...
    public function wx_index_show(){
        ...
        foreach($arr as $key=>$user){
            ...
            $arr_car[$num]['car_pic']="http://47.95.114.183/public/uploads/".
            strtr($user->car_pic,"\\","/");
    ...
    public function wx_space_show(){
        ...
        $arr_car['car_pic']="http://47.95.114.183/public/uploads/".
        strtr($Car->car_pic,"\\","/");
    ...
    public function wx_shaixuan(){//获取所有筛选条件添加到前台
        ...
        foreach($arr['brand'] as $key=>$x){
            $arr['brand'][$num]="http://47.95.114.183/public/uploads/".
            strtr($arr['brand'][$num],"\\","/");
            $num++;
        }
        echo json_encode($arr);
    ...
    public function wx_shaixuan_select(){//根据筛选条件 查询
        ...
        foreach($arr as $key=>$x){
            $arr[$num]['car_pic']="http://47.95.114.183/public/uploads/".
            strtr($x->car_pic,"\\","/");
            $num++;
        }
        echo json_encode($arr);
